...
The `/admin/orders` Magasin selector offers Alle magasiner, MAG and BTV. The URL parameter
...
Changing the selection starts at the first page. “Ryd filtre” preserves the selected Magasin.
